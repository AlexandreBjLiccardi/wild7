 ...
 * Fichier ArcView
 */
public class WildShpFile extends WildSigFile{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildShpFile(){}

// VARIABLES GLOBALES ("Fields") directement renseignées par la documentation
//	protected CoordinateReferenceSystem crsShpFile; // Système de coordonnées propre à SHP
//	protected ShapefileFeatureStore dataStore; // Correspond au flux de lecture du SHP
...
// *** [Généré automatiquement] Ecrivez vos propres variables globales ici. ***
	 ...
	 */
	protected void WILD_initialize_WildShpFile(
...
//		// *** [Généré automatiquement] Ecrivez votre code JAVA ici. ***
	...
	*/
	...
	public WildShpFile(
	 	...
	 	this.WILD_initialize_WildShpFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,(i_confmodel == null) ? 0 : i_confmodel);
	 }
	...
	*/
	 ...
	 public WildShpFile(
	 	...
	 	this.WILD_initialize_WildShpFile(i_WILD_dObject,i_pathToFile,4326,0);
	 }
	...
	*/
	...
	this.WILD_initialize_WildShpFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,0);
	}
