 ...
 * Client d'un service protocole WFS
 */
public class WildWfsService extends WildWebService{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildWfsService(){}
 ...
 */
protected void WILD_initialize_WildWfsService(
...
//	// Amorce de la classe
	...
	WILD_initialize_WildWebService(i_WILD_dObject,clientId,clientPwd,hostName,hostIp);
...
public WildWfsService(
	...
	this.WILD_initialize_WildWfsService(i_WILD_dObject,i_clientId,i_clientPwd,i_hostName,i_hostIp);
}
...
public WildWfsService(
	...
	this.WILD_initialize_WildWfsService(i_WILD_dObject,null,null,i_hostName,i_hostIp);
}
