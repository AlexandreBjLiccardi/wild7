 ...
 */
protected void WILD_initialize_WildWktFile(
...
//	// Amorce de la classe
	...
	WILD_initialize_WildSigFile(i_WILD_dObject,i_pathToFile,i_srid,i_confmodel);
...
public WildWktFile(
	...
	this.WILD_initialize_WildWktFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,(i_confmodel == null) ? 0 : i_confmodel);
}
...
public WildWktFile(
	...
	if(mimeEncoding==null)mimeEncoding="UTF-8";
	this.WILD_initialize_WildWktFile(i_WILD_dObject,i_pathToFile,i_srid,0);
}
...
public WildWktFile(
	...
	this.WILD_initialize_WildWktFile(i_WILD_dObject,i_pathToFile,4326,0);
}
