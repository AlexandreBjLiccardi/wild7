 ...
 * Fichier moissonnable, de métadonnées GMD
 */
public class WildGmdFile extends WildMarkUpFile{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildGmdFile(){}
 ...
 */
protected void WILD_initialize_WildGmdFile(
...
public WildGmdFile(
	...
	this.WILD_initialize_WildGmdFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,null,null,null);
}
...
public WildGmdFile(
	...
	this.WILD_initialize_WildGmdFile(i_WILD_dObject,i_pathToFile,"UTF-8",null,null,null);
}
...
public WildGmdFile(
	...
	if(mimeEncoding==null)mimeEncoding="UTF-8";
	this.WILD_initialize_WildGmdFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,i_nameSpaces,i_versionXml,null);
}
...
public WildGmdFile(
	...
	this.WILD_initialize_WildGmdFile(i_WILD_dObject,i_pathToFile,"UTF-8",i_nameSpaces,i_versionXml,null);
}
...
public WildGmdFile(
	...
	if(mimeEncoding==null)mimeEncoding="UTF-8";
	this.WILD_initialize_WildGmdFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,null,i_versionXml,i_defaultNameSpace);
}
...
public WildGmdFile(
	...
	this.WILD_initialize_WildGmdFile(i_WILD_dObject,i_pathToFile,"UTF-8",null,i_versionXml,i_defaultNameSpace);
}
...
/**
 * Définition d'un contenu gmd
 * @param gmdContents	Contenu à mettre à jour
 */
public void DVP_setContents(String gmdContents) {
