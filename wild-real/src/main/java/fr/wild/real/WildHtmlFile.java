 ...
 */
protected void WILD_initialize_WildHtmlFile(
...
public WildHtmlFile(
	...
	this.WILD_initialize_WildHtmlFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,null,null,null);
}
...
public WildHtmlFile(
	...
	this.WILD_initialize_WildHtmlFile(i_WILD_dObject,i_pathToFile,"UTF-8",null,null,null);
}
...
public WildHtmlFile(
	...
	if(mimeEncoding==null)mimeEncoding="UTF-8";
	this.WILD_initialize_WildHtmlFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,i_nameSpaces,i_versionXml,null);
}
...
public WildHtmlFile(
	...
	this.WILD_initialize_WildHtmlFile(i_WILD_dObject,i_pathToFile,"UTF-8",i_nameSpaces,i_versionXml,null);
}
...
public WildHtmlFile(
	...
	if(mimeEncoding==null)mimeEncoding="UTF-8";
	this.WILD_initialize_WildHtmlFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,null,i_versionXml,i_defaultNameSpace);
}
...
public WildHtmlFile(
	...
	this.WILD_initialize_WildHtmlFile(i_WILD_dObject,i_pathToFile,"UTF-8",null,i_versionXml,i_defaultNameSpace);
}
