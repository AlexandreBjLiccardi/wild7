 ...
 * Client d'un service protocole FTP
 */
public class WildFtpService extends WildService{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildFtpService(){}
 ...
 */
protected void WILD_initialize_WildFtpService(
...
//	// Amorce de la classe
	...
	WILD_initialize_WildService(i_WILD_dObject,clientId,clientPwd,hostName,hostIp);
...
public WildFtpService(
	...
	this.WILD_initialize_WildFtpService(i_WILD_dObject,i_clientId,i_clientPwd,i_hostName,i_hostIp);
}
