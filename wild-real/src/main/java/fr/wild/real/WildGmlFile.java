 ...
 * Fichier XML à composante géographique
 */
public class WildGmlFile extends WildSigFile{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildGmlFile(){}
...
// *** [Généré automatiquement] Ecrivez vos propres variables globales ici. ***
	 ...
	 */
	protected void WILD_initialize_WildGmlFile(
...
//		// *** [Généré automatiquement] Ecrivez votre code JAVA ici. ***
	...
	*/
	...
	public WildGmlFile(
	 	...
	 	this.WILD_initialize_WildGmlFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,(i_confmodel == null) ? 0 : i_confmodel);
	 }
	...
	*/
	 ...
	 public WildGmlFile(
	 	...
	 	this.WILD_initialize_WildGmlFile(i_WILD_dObject,i_pathToFile,4326,0);
	 }
	...
	*/
	...
	this.WILD_initialize_WildGmlFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,0);
	}
