 ...
 * Fichier Mif/Mid standard d'échange MapInfo
 */
public class WildMifMidFile extends WildSigFile{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildMifMidFile(){}
...
// *** [Généré automatiquement] Ecrivez vos propres variables globales ici. ***
	 ...
	 */
	protected void WILD_initialize_WildMifMidFile(
...
//		// *** [Généré automatiquement] Ecrivez votre code JAVA ici. ***
	...
	*/
	...
	public WildMifMidFile(
	 	...
	 	this.WILD_initialize_WildMifMidFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,(i_confmodel == null) ? 0 : i_confmodel);
	 }
	...
	*/
	 ...
	 public WildMifMidFile(
	 	...
	 	this.WILD_initialize_WildMifMidFile(i_WILD_dObject,i_pathToFile,4326,0);
	 }
	...
	*/
	...
	this.WILD_initialize_WildMifMidFile(i_WILD_dObject,i_pathToFile,(i_srid == null) ? 4326 : i_srid,0);
	}
