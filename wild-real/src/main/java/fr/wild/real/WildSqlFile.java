 ...
 */
protected void WILD_initialize_WildSqlFile(
...
//	// Amorce de la classe
	...
	WILD_initialize_WildScriptFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,null,null,null,null);
...
public WildSqlFile(
	...
	this.WILD_initialize_WildSqlFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding);
}
...
public WildSqlFile(
	...
	this.WILD_initialize_WildSqlFile(i_WILD_dObject,i_pathToFile,"UTF-8");
}
