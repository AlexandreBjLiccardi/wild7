 ...
 * Client d'une base de données Oracle
 */
public class WildOracleService extends WildDbmsService{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildOracleService(){}
 ...
 */
protected void WILD_initialize_WildOracleService(
...
public WildOracleService(
	...
	this.WILD_initialize_WildOracleService(i_WILD_dObject,i_clientId,i_clientPwd,i_hostName,i_hostIp);
}
