 ...
 * Client d'un service fournisseur d'un flux quelconque
 */
public abstract class WildService extends WildClass{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildService(){}
 ...
 */
protected void WILD_initialize_WildService(
...
public WildService(
	...
	this.WILD_initialize_WildService(i_WILD_dObject,i_clientId,i_clientPwd,i_hostName,i_hostIp);
}
...
public WildService(
	...
	this.WILD_initialize_WildService(i_WILD_dObject,"null","null",i_hostName,i_hostIp);
}
