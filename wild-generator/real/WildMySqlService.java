 ...
 * Client d'une base de données MySql
 */
public class WildMySqlService extends WildDbmsService{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildMySqlService(){}
 ...
 */
protected void WILD_initialize_WildMySqlService(
...
public WildMySqlService(
	...
	this.WILD_initialize_WildMySqlService(i_WILD_dObject,i_clientId,i_clientPwd,i_hostName,i_hostIp);
}
