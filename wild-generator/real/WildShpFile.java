...
// VARIABLES GLOBALES ("Fields") directement renseignées par la documentation
	...
	protected ShapefileDataStore dataStore; // Correspond au flux de lecture du SHP
...
public WildShpFile(
	...
	this.WILD_initialize_WildShpFile(i_WILD_dObject,i_pathToFile,i_srid);
}
...
public WildShpFile(
	...
	this.WILD_initialize_WildShpFile(i_WILD_dObject,i_pathToFile,4326);
}
