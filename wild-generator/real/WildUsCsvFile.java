 ...
 * Fichier texte délimité, norme anglo-saxonne
 */
public class WildUsCsvFile extends WildFlatFile{

// Constructeur vide pour permettre la création de constructeurs différents par les classes héritées
	protected WildUsCsvFile(){}
 ...
 */
protected void WILD_initialize_WildUsCsvFile(
...
public WildUsCsvFile(
	...
	this.WILD_initialize_WildUsCsvFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding,i_delimiter,i_quoter,i_escapeChar,i_lineDelimiter);
}
...
public WildUsCsvFile(
	...
	this.WILD_initialize_WildUsCsvFile(i_WILD_dObject,i_pathToFile,"UTF-8",",",""","ESC8","ESC8n");
}
