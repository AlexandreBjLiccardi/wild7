...
//	//	//	Output	"addNode_output1" : Nombre de lignes affectées (Integer)
	//	this.WILD_setOutput("addNode_output1",/*** Valeur à remonter en output ***/); // Ne pas modifier
...
//	//	//	Output	"dropFirstNode_output1" : Nombre de lignes affectées (Integer)
	//	this.WILD_setOutput("dropFirstNode_output1",/*** Valeur à remonter en output ***/); // Ne pas modifier
...
//	//	//	Output	"updateNode_output1" : Nombre de nœuds affectés (Integer)
	//	this.WILD_setOutput("updateNode_output1",/*** Valeur à remonter en output ***/); // Ne pas modifier
