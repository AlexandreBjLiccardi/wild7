 ...
 */
protected void WILD_initialize_WildOdsFile(
...
public WildOdsFile(
	...
	this.WILD_initialize_WildOdsFile(i_WILD_dObject,i_pathToFile,i_mimeEncoding);
}
...
public WildOdsFile(
	...
	this.WILD_initialize_WildOdsFile(i_WILD_dObject,i_pathToFile,"UTF-8");
}
